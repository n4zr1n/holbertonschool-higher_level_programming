...
class Rectangle:
    """
    Defines a rectangle with width, height, and methods to compute area, perimeter,
    compare rectangles, and represent them as strings.
    """
    ...
    def __del__(self):
        """Print a message when instance is deleted and decrease count."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
